    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mt-10 mx-auto flex flex-wrap items-center">
            <div class="lg:w-2/6 md:w-1/2 bg-gray-50 rounded-lg p-8 flex flex-col mx-auto w-full mt-10 md:mt-0">
                <h2 class="text-gray-900 text-2xl font-medium title-font mb-5 text-center">배송지 등록</h2>
                ...
                <div class="form-group flex flex-wrap">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"
                               class="flex-grow text-gray-700 bg-yellow-200 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-400 rounded text-base"><br>
                    </div>
                </div>
                ...
                <div class="flex mt-3">
                    <button class="flex-auto mr-1 text-black bg-yellow-200 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-300 rounded text-lg">주소등록</button>
