    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
        ...
        <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" id="cardNumber" name="cardNumber" value="${card.cardNumber}" class="w-full bg-white rounded border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="relative mb-4">
                <label for="expiredDate" class="leading-7 text-sm text-gray-600">카드 유효기간(MM/YY)</label>
                <input type="text" id="expiredDate" name="expiredDate" value="${card.expiredDate}" class="w-full bg-white rounded border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="relative mb-4">
                <label for="cardPassword" class="leading-7 text-sm text-gray-600">카드 비밀번호 앞 2자리</label>
                <input type="password" id="cardPassword" name="cardPassword" value="${card.cardPassword}" class="w-full bg-white rounded border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            <div class="relative mb-4">
